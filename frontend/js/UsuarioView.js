...
function remove() {
  let cod = document.getElementById('codDelete');
  let objUsuario = {
    cod: cod.value,
  };

  removerUsuarios(objUsuario);

  return false;
}

function alterar() {
  let cod = document.getElementById('codUpdate');
  let nome = document.getElementById('nomeU');
  let email = document.getElementById('emailU');
  let login = document.getElementById('loginU');
  let senha = document.getElementById('senhaU');
  let validarSenha = document.getElementById('validarSenhaU');
